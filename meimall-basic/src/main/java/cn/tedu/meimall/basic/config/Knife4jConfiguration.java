package cn.tedu.meimall.basic.config;
...
public class Knife4jConfiguration {
     ...
     * 標題
     */
    private static final String TITLE = "廚房一隻咩-地址資料服務-在線API文檔";
    /**
     * 簡介
     */
    private static final String DESCRIPTION = "廚房一隻咩-地址資料服務-在線API文檔";
    /**
     * 服務條款URL
     */
