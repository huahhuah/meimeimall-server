package cn.tedu.meimall.front.account.config;

import cn.tedu.meimall.common.enumerator.ServiceCode;
import cn.tedu.meimall.common.web.JsonResult;
import cn.tedu.meimall.front.account.filter.JwtAuthorizationFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
       //配置Security框架不使用Session
        ...
        //將自定義的擠些JWT的過濾器添加到Security框架的過濾器鏈中
