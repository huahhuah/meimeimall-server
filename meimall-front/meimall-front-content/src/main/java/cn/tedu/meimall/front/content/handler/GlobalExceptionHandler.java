package cn.tedu.meimall.front.content.handler;
...
public class GlobalExceptionHandler {
    ...
    public JsonResult handleConstraintViolationException(ConstraintViolationException e){
        ...
        StringBuilder stringBuilder = new StringBuilder();
        Set<ConstraintViolation<?>> configurations = e.getConstraintViolations();
        for (ConstraintViolation<?> constraintViolation : configurations) {
    ...
    public JsonResult handleThrowable(Throwable e){
        ...
        String message = "服務器忙,請稍後再嘗試!【看到這句時,你應該檢查服務啟端的控制台,並在全局異常處理器中添加處理異常的方法】";
        log.warn(message);
