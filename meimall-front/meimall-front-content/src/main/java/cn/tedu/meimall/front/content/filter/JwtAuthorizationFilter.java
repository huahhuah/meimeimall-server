package cn.tedu.meimall.front.content.filter;
...
import cn.tedu.meimall.front.content.dao.cache.IUserCacheRepository;
...
public class JwtAuthorizationFilter extends OncePerRequestFilter implements HttpConsts, JwtConsts {
    ...
    protected void doFilterInternal(HttpServletRequest request, @NotNull HttpServletResponse  response,@NotNull FilterChain filterChain) throws ServletException, IOException {
        ...
        try{
            ...
            String message = "非法訪問,您的本次操作已經被記錄!";
            ...
            String message = "服務器忙,請稍後再試!【看到這句時,你應該檢查服務器端的控制器,並在JwtAuthorizationFilter中解析JWT時添加處理異常的catch程式碼】";
